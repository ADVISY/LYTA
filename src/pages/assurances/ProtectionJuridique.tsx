...
const ProtectionJuridique = () => {
  ...
  const slides = [
    {
      image: juridiqueModerne,
      title: "Protection complète",
      description: "Défendez vos droits dans tous les domaines",
    },
    {
      image: familyConsultation,
      title: "Conseil juridique gratuit",
      description: "Hotline juridique 24/7 à votre disposition",
    },
    {
      image: clientHappy,
      title: "Frais couverts",
      description: "Avocats et procédures pris en charge",
    },
  ];
