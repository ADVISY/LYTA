...
export default function ClientDetail() {
  ...
  const canManageClientPortal = can('clients', 'update') || can('settings', 'update');
  ...
  }, [id, loadDocuments, policiesLoading]);
  ...
  const handleCreateClientAccount = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${t('clientDetail.emailSentTo') || "Un email a été envoyé à"} ${client.email}`,
      });
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : t('clientDetail.cannotCreateAccount') || "Impossible de créer le compte",
        variant: "destructive",
      });
    } finally {
  ...
  const handleResendInvitation = async () => {
    ...
    try {
      ...
      toast({
        title: t('clientDetail.invitationResent') || "Invitation renvoyée",
        description: `${t('clientDetail.emailSentTo') || "Un nouvel email a été envoyé à"} ${client.email}`,
      });
    } catch (error) {
      console.error("Error resending invitation:", error);
      toast({
        title: t('common.error') || "Erreur",
        description: error instanceof Error ? error.message : t('clientDetail.cannotResendInvitation') || "Impossible de renvoyer l'invitation",
        variant: "destructive",
      });
    } finally {
            ...
            <TabsContent value="suivis">
              <Card>
                ...
                <CardContent>
                  ...
                  <DataPagination
                    page={suivisPage}
                    totalPages={suivisTotalPages}
                    totalCount={suivisTotalCount}
                    onPageChange={suivisGoToPage}
                  />
                </CardContent>
              </Card>
            </TabsContent>
