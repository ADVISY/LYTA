...
const TRANSLATION_DEFAULTS: Record<SupportedLanguage, Record<string, string>> = {
  fr: {
    'depositContract.common.additionalDocs': 'Documents supplementaires',
    'depositContract.vita.untilRetirement': "Jusqu'a la retraite",
    ...
    'depositContract.vita.docProposal': 'Proposition avec declaration de sante',
    'depositContract.vita.docIdentity': "Piece d'identite / attestation de domicile",
    'depositContract.vita.docAdequacy': 'Protocole / rapport de conseil',
    'depositContract.vita.docDirectDebit': 'Autorisation de debit direct',
    'depositContract.vita.docMinutes': 'Proces-verbal de conseil',
    'depositContract.business.finalization': 'Finalisation',
    'depositContract.business.staffCount': 'Details du personnel',
    'depositContract.business.womenCount': 'Femmes - nombre',
    'depositContract.business.womenAvgAge': 'Femmes - age moyen',
    'depositContract.business.womenSalaries': 'Femmes - salaires',
    'depositContract.business.menCount': 'Hommes - nombre',
    'depositContract.business.menAvgAge': 'Hommes - age moyen',
    'depositContract.business.menSalaries': 'Hommes - salaires',
    'depositContract.business.zefixNote': 'Extrait Zefix recommande avant validation.',
    ...
    'forms.familyMember.success.addedDescription': '{{name}} a ete ajoute(e) a la famille et a la liste des adresses',
    'forms.familyMember.errors.createClientError': 'Impossible de creer le client lie',
    'forms.familyMember.errors.genericError': 'Une erreur inattendue est survenue',
    'common.mr': 'Monsieur',
    'common.mrs': 'Madame',
    'common.allTime': 'Toute la periode',
    ...
    'clientDetail.emailSentTo': 'Un email a ete envoye a',
    'clientDetail.cannotCreateAccount': 'Impossible de creer le compte',
    'clientDetail.invitationResent': 'Invitation renvoyee',
