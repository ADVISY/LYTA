...
const isBlockedDomain = hostname.endsWith('.lovable.app') || hostname.endsWith('.lovableproject.com');
const isDevEnvironment = hostname === 'localhost' || hostname.startsWith('192.168.');

if (isBlockedDomain && !isDevEnvironment) {
