...
-- Enable LYTA Tools for Advisy tenant (pilot) - skip if tenant doesn't exist
INSERT INTO public.tenant_feature_flags (tenant_id, lyta_tools_enabled)
SELECT 'e8d1cab6-1053-49f8-90dc-eed500b8be37', true
WHERE EXISTS (SELECT 1 FROM public.tenants WHERE id = 'e8d1cab6-1053-49f8-90dc-eed500b8be37');
