-- Second pass for JCG Consulting: catch Julien if the imported collaborator
-- row stores the name outside first_name or only in the email.
...
BEGIN
  ...
  RAISE NOTICE
    'JCG Julien cleanup done: matched_collaborators=%, matched_users=%, deleted_auth_users=%',
    v_target_count,
    v_target_user_count,
