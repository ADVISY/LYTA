-- Fix: King users should always require SMS 2FA regardless of tenant settings
-- This aligns the RPC with ProtectedRoute behavior
...
BEGIN
  ...
  -- King users always require SMS 2FA
  IF v_role = 'king' THEN
    v_requires_sms := TRUE;
  ELSE
