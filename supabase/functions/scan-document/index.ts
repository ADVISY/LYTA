...
- VIE — Vie individuelle, 3e pilier A/B, vie risque, vie mixte, rente viagère
  Signaux: "3e pilier", "pilier 3a", "pilier 3b", "vie individuelle", "rente viagère",
  "capitalisation", "prévoyance liée", "prévoyance libre", "3a", "3b"
  Compagnies typiques (TOUJOURS VIE, JAMAIS LCA même si la facture ressemble):
  PAX, Swiss Life Vie individuelle, Helvetia Vie, AXA Vie, Generali Vie,
  Bâloise Vie, Mobilière Vie, Vaudoise Vie, Allianz Vie, Federali, Skandia,
  Zurich Vie, La Mobilière Vie.
  ⚠️ Si la compagnie est un assureur VIE et que tu hésites entre LCA et VIE → choisir VIE.

- LPP — 2e pilier, prévoyance professionnelle
  Signaux: "LPP", "2e pilier", "2P", "prévoyance professionnelle", "BVG",
  "caisse de pension", "fondation collective", "certificat de prévoyance",
  "compte de libre passage", "libre passage", "Freizügigkeit"
  Compagnies typiques: Fondation Institution Supplétive, Centrale du 2e pilier,
  PUBLICA, ASGA, Tellco LPP, Liberty, Swiss Life LPP, Helvetia LPP, AXA LPP,
  Bâloise LPP, Allianz LPP.

- ⚠️ LEMANIA (cas spécifique) :
  Lemania-Pension Hub couvre LES DEUX : VIE (3e pilier) ET LPP (2e pilier).
  Tu DOIS distinguer selon le document :
  - Document parle de "3e pilier / 3a / 3b / prévoyance liée / libre" → branch_code=VIE
  - Document parle de "LPP / 2e pilier / certificat de prévoyance / caisse de pension /
    libre passage" → branch_code=LPP
  - JAMAIS classer Lemania en LCA (ce n'est PAS un assureur maladie).
