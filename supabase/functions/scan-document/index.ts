...
- VIE — Vie individuelle, 3e pilier A/B, vie risque, vie mixte, rente viagère
  Signaux: "3e pilier", "pilier 3a", "pilier 3b", "vie individuelle", "rente viagère", "capitalisation", "prévoyance liée", "prévoyance libre"
  Compagnies typiques (TOUJOURS VIE, JAMAIS LCA même si la facture ressemble):
  Lemania-Pension Hub, Lemania-Pension, PAX, Swiss Life Vie individuelle, Helvetia Vie,
  AXA Vie, Generali Vie, Bâloise Vie, Mobilière Vie, Vaudoise Vie, Allianz Vie,
  Federali, Skandia, Zurich Vie, La Mobilière Vie.
...
- LPP — 2e pilier, prévoyance professionnelle
  ...
  Lemania Caisse de retraite, PUBLICA, ASGA, Tellco LPP, Liberty.
